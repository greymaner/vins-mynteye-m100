...
{
    pub_latest_odometry = n.advertise<nav_msgs::Odometry>("imu_propagate", 100);
    pub_path = n.advertise<nav_msgs::Path>("path", 100);
    pub_relo_path = n.advertise<nav_msgs::Path>("relocalization_path", 100);
    pub_odometry = n.advertise<nav_msgs::Odometry>("odometry", 100);
        //广播历史帧
    pub_saved_keyframe = n.advertise<nav_msgs::Odometry>("saved_keyframe", 100);

    pub_point_cloud = n.advertise<sensor_msgs::PointCloud>("point_cloud", 100);
    pub_margin_cloud = n.advertise<sensor_msgs::PointCloud>("history_cloud", 100);
    pub_key_poses = n.advertise<visualization_msgs::Marker>("key_poses", 100);
    pub_camera_pose = n.advertise<nav_msgs::Odometry>("camera_pose", 100);
    pub_camera_pose_visual = n.advertise<visualization_msgs::MarkerArray>("camera_pose_visual", 100);
    pub_keyframe_pose = n.advertise<nav_msgs::Odometry>("keyframe_pose", 100);
    ...
    pub_keyframe_point = n.advertise<sensor_msgs::PointCloud>("keyframe_point", 100);
    pub_extrinsic = n.advertise<nav_msgs::Odometry>("extrinsic", 100);
    pub_relo_relative_pose=  n.advertise<nav_msgs::Odometry>("relo_relative_pose", 100);
