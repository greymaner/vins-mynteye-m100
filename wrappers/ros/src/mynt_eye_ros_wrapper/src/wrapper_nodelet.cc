...
class ROSWrapperNodelet : public nodelet::Nodelet {
  ...
  */
  ...
  void publishImu(
    ...
    msg.linear_acceleration.x = data.imu->accel[2] * gravity_;
    msg.linear_acceleration.y = -data.imu->accel[1] * gravity_;
    msg.linear_acceleration.z = data.imu->accel[0] * gravity_;
    ...
    msg.angular_velocity.x = data.imu->gyro[2] * M_PI / 180;
    msg.angular_velocity.y = -data.imu->gyro[1] * M_PI / 180;
    msg.angular_velocity.z = data.imu->gyro[0] * M_PI / 180;
